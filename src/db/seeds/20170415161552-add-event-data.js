...
module.exports = {
  up: function (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert('Event', [{
      ...
      endTime: moment().add(2, 'days').add(2, 'hours').format(),
      privacy: 3,
      category: 'Crafts',
      rsoId: rsos[3],
      universityId: 1,
      ...
      latitude: 28.604010,
      longitude: -81.199116,
      imageUrl: 'http://shootoholic.com/wp-content/uploads/2015/10/target-practice-for-skeet-shooting-shootoholic.jpg',
      startTime: moment().add(4, 'days').format(),
      endTime: moment().add(4, 'days').add(2, 'hours').format(),
      privacy: 3,
      ...
      endTime: moment().add(5, 'days').add(2, 'hours').format(),
      privacy: 2,
      category: 'Entertainment',
      rsoId: rsos[2],
      universityId: 1,
      ...
      endTime: moment().add(1, 'days').add(2, 'hours').format(),
      privacy: 3,
      category: 'Politics',
      rsoId: rsos[1],
      universityId: 1,
